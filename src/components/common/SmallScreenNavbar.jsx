...
export default function SmallScreenNavbar({ handleCrossButton, isClose }) {
    ...
    return (
      ...
      border-l-richblack-700 w-[40%] ${location.pathname !== "/" ? "bg-richblack-800" : "bg-richblack-900"
                } transition-all duration-200`}
        >

            <div className={`flex flex-col ${location.pathname !== "/" ? "bg-richblack-800" : "bg-richblack-900"
                }  relative  w-[100%] h-[95%] 
         items-center gap-5`}>
